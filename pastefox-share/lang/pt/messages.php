...
return [
    ...
    'api_key_missing' => 'Chave API do PasteFox não configurada. Adicione-a nas configurações do plugin.',
    'expires_7_days' => '⚠️ Sem chave API, o paste expira em 7 dias',

    // Settings
    'settings_saved' => 'Configurações salvas',
    'section_api' => 'Configuração da API',
    'section_api_description' => 'Sem chave API, os pastes expiram após 7 dias e são sempre públicos.',
    'section_paste' => 'Configurações do paste',
    'api_key' => 'Chave API',
    'api_key_helper' => 'Opcional – Obtenha sua chave API em https://pastefox.com/dashboard',
    'visibility' => 'Visibilidade',
    'visibility_public' => 'Público',
    'visibility_private' => 'Privado (requer chave API)',
    'visibility_helper' => 'Pastes privados requerem uma chave API',
    ...
    'effect_puzzle' => 'Revelação puzzle',
    ...
    'section_custom_domain_description' => 'Use seu próprio domínio para compartilhar pastes. Requer chave API. Gerencie domínios em Painel → Domínios personalizados.',
    ...
    'custom_domain_no_api_key' => 'Chave API necessária para domínios personalizados',
